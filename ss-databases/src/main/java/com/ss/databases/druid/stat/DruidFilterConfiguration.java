...
public class DruidFilterConfiguration {
    ...
    private static final String FILTER_STAT_PREFIX = "ss.datasource.druid.filter.stat";
    private static final String FILTER_CONFIG_PREFIX = "ss.datasource.druid.filter.config";
    private static final String FILTER_ENCODING_PREFIX = "ss.datasource.druid.filter.encoding";
    private static final String FILTER_SLF4J_PREFIX = "ss.datasource.druid.filter.slf4j";
    private static final String FILTER_LOG4J_PREFIX = "ss.datasource.druid.filter.log4j";
    private static final String FILTER_LOG4J2_PREFIX = "ss.datasource.druid.filter.log4j2";
    private static final String FILTER_COMMONS_LOG_PREFIX = "ss.datasource.druid.filter.commons-log";
    private static final String FILTER_WALL_PREFIX = "ss.datasource.druid.filter.wall";
