...
import com.ss.databases.shardingsphere.shadow.SpringBootShadowRuleConfigurationProperties;
...
@ConditionalOnProperty(prefix = "ss.shardingsphere", name = "enabled", havingValue = "true", matchIfMissing = true)
