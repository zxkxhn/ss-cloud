...
public final class EncryptRuleCondition extends SpringBootCondition {
    ...
    private static final String ENCRYPT_ENCRYPTORS_PREFIX = "ss.shardingsphere.encrypt.encryptors";
    
    private static final String ENCRYPT_TABLES_PREFIX = "ss.shardingsphere.encrypt.tables";
