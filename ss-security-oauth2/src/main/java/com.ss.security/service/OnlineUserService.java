...
import com.ss.security.service.dto.OnlineUserDto;
...
//            e.printStackTrace();
//        }
//        redisUtils.setEx(properties.getOnlineKey() + token, onlineUserDto, properties.getTokenValidityInSeconds()/1000, TimeUnit.SECONDS);
    }
...
//        );
    ...
    public List<OnlineUserDto> getAll(String filter){
        List<String> keys = new ArrayList<>(redisUtils.keys(properties.getOnlineKey() + "*"));
